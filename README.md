...
- Examples of the trace files are given for several test cases -- the files are named to reflect the inputs -- traceXY.txt where X is the total size of the sort (e.g. 50MB) and Y is the record size (e.g. 2000KB).
